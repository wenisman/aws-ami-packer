...
# firewall setup
cmd.exe /c netsh advfirewall firewall add rule name="secure winrm port 5896" dir=in action=allow protocol=TCP localport=5986
cmd.exe /c netsh advfirewall firewall add rule name="Open Port 80" dir=in action=allow protocol=TCP localport=80
